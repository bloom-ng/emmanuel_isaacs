<div class="px-12 my-4">
    ...
    >
      <ol class="grid grid-cols-3 text-sm font-medium text-gray-500">
        <li class="relative flex justify-start text-amber-600">
          <span
            class="absolute -bottom-[1.75rem] start-0 rounded-full bg-amber-600 text-white"
          >
            <svg
              class="h-5 w-5"
        ...
        <li class="relative flex justify-center text-amber-600">
          <span
            class="absolute -bottom-[1.75rem] left-1/2 -translate-x-1/2 rounded-full bg-amber-600 text-white"
          >
            <svg
              class="h-5 w-5"
              xmlns="http://www.w3.org/2000/svg"
