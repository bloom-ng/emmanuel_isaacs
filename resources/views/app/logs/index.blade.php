                        ...
                        <thead class="text-gray-700">
                            <tr>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.logs.inputs.action')
                                </th>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.logs.inputs.user_id')
                                </th>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.logs.inputs.description')
                                </th>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.logs.inputs.data')
                                </th>
                                <th></th>
                            </tr>
                        </thead>
