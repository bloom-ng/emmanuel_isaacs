...
<div class="flex flex-wrap">
    ...
    <x-inputs.group class="w-full">
        <x-inputs.image id="image_2" name="image_2" label="Alternate Image"
    ...
    <x-inputs.group class="w-full">
        <x-inputs.number
            name="weight"
            label="Weight"
            :value="old('weight', ($editing ? $product->weight : 0))"
            max="255"
            step="0.01"
            placeholder="Weight"
            required
    ...
    <x-inputs.group class="w-full">
        <x-inputs.number
            name="height"
            label="Height"
            :value="old('height', ($editing ? $product->height : 0))"
            max="255"
            step="0.01"
            placeholder="Height"
            required
    ...
    <x-inputs.group class="w-full">
        <x-inputs.number
            name="length"
            label="Length"
            :value="old('length', ($editing ? $product->length : 0))"
            max="255"
            step="0.01"
            placeholder="Length"
            required
    ...
    <x-inputs.group class="w-full">
        <x-inputs.number
            name="price"
            label="Price"
            :value="old('price', ($editing ? $product->price : 0))"
            max="255"
            step="0.01"
            placeholder="Price"
            required
    ...
    <x-inputs.group class="w-full">
        <x-inputs.number
            name="sale_price"
            label="Sale Price"
            :value="old('sale_price', ($editing ? $product->sale_price : 0))"
            max="255"
            step="0.01"
    ...
    <x-inputs.group class="w-full">
        <x-inputs.number
            ...
            :value="old('shipping_price', ($editing ? $product->shipping_price : 0))"
            max="255"
            step="0.01"
    ...
    <x-inputs.group class="w-full">
        <x-inputs.basic
            type="file"
            name="download_link"
            label="Please upload File for virtual product"
