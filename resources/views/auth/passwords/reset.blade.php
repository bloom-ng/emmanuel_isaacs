        ...
        <x-partials.card>
            ...
            <div class="flex-auto p-6">
                <form method="POST" action="{{ route('password.reset') }}">
                    ...
                    <div class="mb-4 flex flex-wrap ">
                        <label for="password" class="md:w-1/3 pr-4 pl-4 pt-2 pb-2 leading-normal md:text-right">{{
                            __('Password') }}</label>
                    ...
                    <div class="mb-4 flex flex-wrap ">
                        <label for="password-confirm"
                            class="md:w-1/3 pr-4 pl-4 pt-2 pb-2 leading-normal md:text-right">{{ __('Confirm Password')
                            }}</label>
